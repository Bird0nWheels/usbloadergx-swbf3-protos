...
The SWBF3 dev builds covered by this fork are:
...
This fork is specifically what you want for SWBF3 -- the builds above
need both apploader-time fixups (production-boundary rewrite and
